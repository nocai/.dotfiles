...
function M.on_attach(client, buffer)
	...
	vim.keymap.set("n", ivim.lsp_keys.GotoImplementation, "<cmd>Telescope lsp_implementations theme=get_ivy<cr>",
		opts)
	...
	vim.keymap.set("n", "]d", M._diagnostic_goto(true), opts)
	vim.keymap.set("n", "[d", M._diagnostic_goto(false), opts)
